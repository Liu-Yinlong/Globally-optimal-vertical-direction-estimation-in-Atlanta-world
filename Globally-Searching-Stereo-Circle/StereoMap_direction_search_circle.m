function [StereoMap_direction_circle,iter] = StereoMap_direction_search_circle(data,epsilon)
%DIRECTION_SEARCH_CIRCLE 
%   data:input surface normals
%   epsilon:inlier threshold(e.g., 0.0175)

B=[0;0;1];%[init-x,init-y,radius]
branches=[];
...
StereoMap_direction_circle = StereoMap_point_2d_3d(StereoMap_direction_2d);
